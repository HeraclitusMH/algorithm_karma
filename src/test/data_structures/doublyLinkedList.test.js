describe('Doubly Linked List:', function () {
    ...
    it('test Node', function () {
        var first = new DoubleListNode("Test")
        first.next = new DoubleListNode("success")
    ...
    it('Push three element', function () {
        ...
        expect(list.tail.prev.val).toBe(6);
    ...
    it('get index entering in the second if', function () {
        const list = new DoublyLinkedList;
        list.push(3);
        list.push(6);
        list.push(9);
    ...
    it('insert second item', function () {
        ...
        expect(list.head.next.val).toBe(12);
        expect(list.head.next.prev.val).toBe(3);
        expect(list.length).toBe(4);
    });
